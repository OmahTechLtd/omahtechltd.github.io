      ...
      <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-8">
        ...
        <div className="bg-gradient-to-r from-black via-[#111111] to-[#222222] p-8 rounded-xl shadow-xl hover:shadow-2xl transition-shadow flex flex-col justify-between">
          <div>
            ...
            <p className="text-gray-300">
              A structured programme built for beginners who want to start building real machine learning models from scratch. Practical, and designed around real outcomes.
            </p>
