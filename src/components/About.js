...
We build data-driven decision support systems for oil and gas operators across Africa, with offices in Lagos and Abuja.        </p>
        <p className="text-gray-300 text-lg mt-6">
Our work sits at the intersection of petroleum engineering and machine learning, enabling us to design systems that reflect how upstream operations actually function.        </p>
        <p className="text-gray-300 text-lg mt-6">
